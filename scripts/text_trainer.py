#!/usr/bin/env python3
"""
Standalone script for text model training (InstructText, DPO, GRPO, Enviroment)
"""
...
def main():
    ...
    parser.add_argument(
        "--reg-ratio", type=float, help="Reg ratio to use for training", default=1.08
    )
    ...
    elif args.task_type == TaskType.GRPOTASK.value or args.task_type == TaskType.ENVTASK.value:
    ...
    while True:
        ...
        if args.task_type == TaskType.GRPOTASK.value or args.task_type == TaskType.ENVTASK.value:
